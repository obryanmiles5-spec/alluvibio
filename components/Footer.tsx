    ...
    <footer className="bg-slate-900 text-white pt-16 flex flex-col mt-auto">
      <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        <div className="col-span-1 md:col-span-1">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="font-bold text-xl tracking-tight text-white">UK PEPTIDES</span>
          </div>
          <p className="text-slate-400 text-sm leading-relaxed mb-6">
            Buy premium research peptides online in the UK. We specialize in high-purity laboratory peptides including Retatrutide, Tirzepatide, and BPC-157. Precision-engineered biochemicals with 99%+ purity guaranteed through rigorous testing.
          </p>
        </div>
      ...
      <div className="bg-slate-950 border-t border-slate-800 py-6 px-4 md:px-8 flex flex-col md:flex-row justify-between items-center text-[11px] text-slate-500 font-medium gap-4 md:gap-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="hidden md:inline">© 2026 UK Peptides</span>
        </div>
